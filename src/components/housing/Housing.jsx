    ...
    return (
        <ContainerHousing id="intro" data-aos="fade-up">
            ...
            <TextHousing>
                ...
                Con un amplio parque y bajada al rio. La cabaña cuenta con capacidad para seis personas,
                con dos baños (uno en suite), cocina completa equipada, living, wi-fi, tv por cable, asador, pileta y cochera.
